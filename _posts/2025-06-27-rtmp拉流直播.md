...
>
> docker run -id --restart=always --name=bvision_srs -p 1936:1935 -p 1985:1985 -p 8080:8080 -p 8000:8000/udp my-srs:latest


快速访问：
1. docker load -i my-srs.tar
2. docker run -d -p 1935:1935 -p 1985:1985 -p 8080:8080 -p 8000:8000/udp my-srs:latest
3. ffmpeg -rtsp_transport tcp -i "rtsp://admin:Bvision@717@192.168.0.3/h264/ch1/main/av_stream" -c copy -f flv rtmp://localhost:1935/live/livestream1
4. 访问： http://localhost:8080/console/ng_index.html#/streams?port=1985&schema=http&host=localhost
